...
<div class="base-top">
    ...
    <div class="simpleTag2 wentit"><img alt="" src="<?php echo $staticUrl;?>images/ask.png"/><?php echo $moduleTag;?></div>
    <div class="right3"><a id="submit_btn" href="#" >完成</a></div>
</div>
<div class="g-tips">
<span><img alt="" src="<?php echo $staticUrl;?>images/tips.png"/></span><span>提问三大招，具体、真实、诚恳<br />问题描述尽量详细，严禁发表不健康或政治敏感问题。</span>
...
<div class="stext">
    ...
    <dl>
        <dt><span class="left"><img alt="" src="<?php echo $staticUrl;?>images/wen2.png"/>问答标题：</span><span class="right">
            <input id="form_title" value="" autocomplete="off" placeholder="填写问答标题" maxlength="50">
        ...
        <dd>
            <textarea id="form_note" name="" cols="" rows="" placeholder="请详细描述你的问题"></textarea>
        </dd>
    </dl>
    </form>
</div>
...
<div class="sfoot">
    <div class="pos"><a id="select_pos" href="#"><img alt="" src="<?php echo $staticUrl;?>images/pos.jpg"/><em>显示你的位置</em></a></div>
    <!-- <div class="photo">
        <ul>
...
<script type="text/javascript">var REQUIRE = {MODULE: 'page/forum/post', TYPE: 'wenda'}, G = {pos: {<?php if(!empty($session['lat'])) echo 'lat:'.$session['lat'].',lon:'.$session['lon']; ?>}};</script>