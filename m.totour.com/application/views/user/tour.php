    ...
    <div class="scon-list">
            ...
            <div class="gright">
                <div class="left">
                    <ul style="margin-top:-0.5rem">
                        ...
                        <li class="red"><%=v.nick_name%><img alt="" src="<?php echo $staticUrl;?>images/<%if v.sex.toUpperCase()=='F'%>dgrilred<%else%>boyred<%/if%>.png"/><%if !!v.age%><font><%=v.age%>岁</font><%/if%><span><img alt="" src="<?php echo $staticUrl;?>images/youji3.png"/>游记贴</span> </li>
        ...
        <div class="list-con">
            <dl>
                ...
                <dd><!--<font>＃和你在一起</font>--><%=v.note%>a</dd>
                </a>
            </dl>
            <%if v.pictures%>
            <div class="list-img">
...
<script type="text/javascript">var REQUIRE = {MODULE: 'page/user/tour'};</script>