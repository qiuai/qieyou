...
<table class="orderList table table-border table-odd">
	...
	<tr>
        ...
        <td><a class="viewInnsInfo" href="javascript:void(0);" ref="<?php echo $order['inn_id'];?>"><?php echo $order['inn_name'];?></a></td>
...
<script type="text/javascript">
    $(function(){	
        ...
        typeSelect.change(function(){
            ...
            window.location.href="<?php echo $baseUrl;?>order/qieyou?state="+currentState+getTime()+"&cid="+typeVal;
        });

		setTimeButton.click(function(){
			window.location.href="<?php echo $baseUrl;?>order/qieyou?state="+currentState+getTime()+geturl();
		});

		$(".tab li").click(function(){ 
			var state = $(this).attr('ref');
			window.location.href="<?php echo $baseUrl;?>order/qieyou?state="+state+getTime()+geturl();
		});
		...
		$('#keywordButton').click(function(){
			...
			{
				window.location.href="<?php echo $baseUrl;?>order/qieyou?key="+key+"&keyword="+keyword;
			}
			else
			{
				alert('error');	
