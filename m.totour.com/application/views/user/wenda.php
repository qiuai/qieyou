            ...
            <div class="gright">
                <div class="left">
                    <ul style="margin-top:-0.5rem">
                        ...
                        <li class="red"><%=v.nick_name%><img alt="" src="<?php echo $staticUrl;?>images/<%if v.sex.toUpperCase()=='F'%>grilred<%else%>boyred<%/if%>.png"/><%if !!v.age%><font><%=v.age%>岁</font><%/if%><span><img alt="" src="<?php echo $staticUrl;?>images/ask4.png"/>问答贴</span> </li>
...
<script type="text/javascript">var REQUIRE = {MODULE: 'page/user/wenda'};</script>