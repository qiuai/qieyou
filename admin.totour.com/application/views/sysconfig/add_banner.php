<h3 class="headline">新增Banner图片</h3>
<form method="post" id="form_sub">
	...
	<tr>
        ...
        <td>
            <p>图片尺寸： 640*200px，大小不超过2MB，允许格式'gif', 'jpg', 'jpeg', 'png'</p>
    ...
    <tr>
        ...
        <td><label><input type="text" value="" class="w300" name="link"></label>  
     ...
     <tr>
        ...
        <td>
        <label><textarea class="w600 textEdit" rows="10" cols="103" name="note"></textarea></label><div class="tips tips-info"><i class="tips-ico"></i><p>限1000字内</p></div></label>			
        </td>
    </tr>
     <tr>
        <td class="leftLabel"><cite>*</cite>排序：</td>
        <td>
        <label><input type="text" value="" class="w50" name="sort" id="sort"></label> 
        <div class="tips" style="display: none;"></div>		
        </td>
    </tr>
    <tr class="space">
...
<script type="text/javascript">
	$(function(){
		...
		form_sub.ajaxForm({
            dataType : 'json',
			type:'POST',
            url:'<?php echo $baseUrl.'sysconfig/add_banner'?>',
