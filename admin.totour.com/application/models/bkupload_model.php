...
class Bkupload_model extends MY_Model {
	...
	* @return bool 成否与否 
	*/
    public function uploadFile($thumb = array(),$thumb_marker='',$link='uploads/') {
		$ret = $this->getUploadedNames($link,$imgtype='imgFile');
        if($ret['code'] != '1'){
			 return $ret;
		}
        if($thumb) {
	...
	*/
	...
	{ 	
		...
		$file_ext = in_array($file_ext,array('jpg')) ? $file_ext : 'jpg';
