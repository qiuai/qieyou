...
<div class="base-top">
    ...
    <div class="simpleTag2"><span><img alt="" src="<?php echo $staticUrl;?>images/jianren5.png"/></span><?php echo $moduleTag;?></div>
...
<div class="stext">
    <form method="post" action="/forum/sendjian">
    <dl>
        <dt><span class="left"><img alt="" src="<?php echo $staticUrl;?>images/tit.png"/>捡人标题：</span><span class="right">
            <input id="form_title" value="" autocomplete="off" placeholder="填写游记标题" maxlength="50">
            </span><span class="clear"></span></dt>
        <dt><span class="left"><img alt="" src="<?php echo $staticUrl;?>images/ditu.png"/>旅游路线：</span><span class="right">
            <input id="form_circuit" value="" autocomplete="off" placeholder="多个请以空格隔开">
            </span><span class="clear"></span></dt>
        <dt><span class="left"><img alt="" src="<?php echo $staticUrl;?>images/time.png"/>出发时间：</span><span class="right">
            <input id="form_date" type="date" value="<?php echo date('Y-m-d'); ?>" autocomplete="off" placeholder="2015-04-24">
            </span><span class="clear"></span></dt>
        <dt><span class="left"><img alt="" src="<?php echo $staticUrl;?>images/date.png"/>旅游天数：</span><span class="right">
            <input id="form_num" type="number" value="3" autocomplete="off" placeholder="">
            </span><span class="clear"></span></dt>
        <dt><span class="left"><img alt="" src="<?php echo $staticUrl;?>images/label.png"/>设置标签：</span><span class="right">
            <input id="form_tag" value="" autocomplete="off" placeholder="多个请以空格隔开">
            </span><span class="clear"></span></dt>
        <dd>
            <textarea id="form_note" name="" cols="" rows="" placeholder="请输入捡人详情（至少要发一张图片）"></textarea>
        </dd>
    </dl>
    </form>
</div>
<div class="picture">
    <ul id="upload_pic">
        <li id="upload_add"><a class="add" href="#"><span class="add-line"><span class="line1"></span><span class="line2"></span></span>
            <div class="progress" style="display:none;">
                <div class="progress-bar"></div>
                <span class="progress-percentage">上传中...</span>
            </div>
            </a>
            <input id="upload_img" class="upload-img" type="file">
        </li>
...
<div class="sfoot">
    ...
    <!-- <div class="photo">
        <ul>
            <li><a href="#"><img alt="" src="<?php echo $staticUrl;?>images/photo.png"/></a><input id="upload_img2" class="upload-img" type="file"></li>
...
<div id="dialog_position" class="dialog-position" style="display:none;">
    <div class="base-top"> <a id="pos_close" href="javascript:;" class="left"><img alt="" src="<?php echo $staticUrl;?>images/back2.png"></a>
...
<div id="dialog_group" class="user-nav" style="display:none;position:fixed;top:0;left:0;z-index:99994;width:100%;height:100%;overflow-x:hidden;overflow-y:auto;">
    <div class="base-top"> <a id="dialog_group_close" href="javascript:;" class="left"><img alt="" src="<?php echo $staticUrl;?>images/back2.png"></a>
        <p class="simpleTag">选择部落</p>
    </div>
    <div class="user-nav-list"> <a href="<?php getUrl('userGroup');?>">
...
<div id="dialog_recommend" class="user-nav" style="display:none;position:fixed;top:0;left:0;z-index:99994;width:100%;height:100%;overflow-x:hidden;overflow-y:auto;">
    <div class="base-top"> <a id="dialog_recommend_close" href="javascript:;" class="left"><img alt="" src="<?php echo $staticUrl;?>images/back2.png"></a>
        <p class="simpleTag">推荐部落</p>
        <a id="dialog_recommend_ok" href="javascript:void(0);" class="right">完成</a> </div>
    <div>
...
<script id="template_position" type="text/template">
    <div class="plist-con">
        ...
        不显示位置
        <div>
            <input data-name="显示你的位置" data-pos="<%=pos.lon%><%=pos.lat%>" class="u-radio u-light" name="pos" id="cb1" type="radio"/>
...
<script type="text/javascript">var REQUIRE = {MODULE: 'page/forum/post', TYPE: 'jianren'}, G = {pos: {<?php if(!empty($session['lat'])) echo 'lat:'.$session['lat'].',lon:'.$session['lon']; ?>}};</script>