...
class Group extends MY_Controller {
	...
	**/
	public function searchKeyWord()
	{
		...
		$order_by = 'create_time DESC';
		$forum = $this->model->get_forum_list($search,$order_by,build_limit($page,$perpage));
		if($forum)
		{
	...
	*/
	public function groupdata() 
	{
		...
		response_json('1',array('group' => $group,'group_member' => $group_member));
    }
	...
	*/		
	...
	private function check_group_info_value()
	{
    ...
    * 圈子管理员帖子管理
	...
	public function forumManage()
	{
		...
		$action = input_string($this->input->post('act'),array('set_top','unset_top','delete'),FALSE,'4001');
