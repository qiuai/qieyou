...
<div class="filter mb20">
    <table class="form table-form">
        ...
        <tr>
            ...
            <td>
                <label><input class="submit" type="submit" id="setTimeButton" value="确认"></label>
            </td>
        </tr>
        </tbody>
    </table>
...
<?php if($type =='innholder'):?>
	...
	<tr>
        ...
        <td>
            <a href="<?php echo $baseUrl; ?>user/edit?type=<?php echo $row['role'];?>&uid=<?php echo $row['user_id'];?>">编辑</a>
...
<?php else:?>
	...
	<?php foreach($users as $key => $BackUser):?>
		<tr>
		<td><?php echo $BackUser['user_name'];?></td>
        <td><?php echo $BackUser['nick_name'];?></td>
        <td><?php echo $BackUser['real_name'];?></td>
        <td><?php echo $BackUser['mobile_phone'];?></td>
        ...
        <td>
            <a href="<?php echo $baseUrl; ?>user/edit?type=<?php echo $BackUser['role'];?>&uid=<?php echo $BackUser['user_id'];?>">编辑</a>
...
$(function(){
	...
	setTimeButton.click(function(){
		var type = $("#type").val();
		window.location.href="<?php echo $baseUrl;?>user?type="+ $("#type").val()+getTime();
	});
	...
	$(".Wdate").on("blur",function(){
		...
		var endTimeAmp = datetimeToUnix(endTime.val()+" 00:00:00");
