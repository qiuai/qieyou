...
<table class="orderList table table-border table-odd">
	...
	<tr>
		...
		<td>
            <a href="<?php echo $baseUrl.'product/'.($product['is_tuan']?'tuanedit':'edit').'?pid='.$product['product_id'];?>" target="_blank">修改</a>
            ...
            <a href="<?php echo $baseUrl.'product/tuanedit?pid='.$product['product_id'].'&act=addtuan';?>" target="_blank">上架成团购</a>
			<?php endif;?>
...
<script type="text/javascript">
    $(function(){
		...
		$('#keywordButton').click(function(){
			...
			if(keyword)
			{
				window.location.href="<?php echo $baseUrl;?>product?keyword="+keyword;
			}
			else
			{
				alert('error');	
