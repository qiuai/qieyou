...
<form method="post" id="form_sub">
	...
	<tr>
        ...
        <td><label><input type="text" value="" class="w200" name="quan_name" ></label>
         <div class="tips" style="display: none;"></div> 	
        </td>
    </tr>
    <tr>
        <td class="leftLabel"><cite>*</cite>抵用券面额：</td>
        <td><label><input type="text" value="" class="w100" name="amount">&nbsp;元</label>   
         <div class="tips" style="display: none;"></div>  
        </td>
    </tr>
    <tr>
        <td class="leftLabel"><cite></cite>张数：</td>
        <td><label><input type="text" value="" class="w100" name="total">&nbsp;张</label>
        <div class="tips tips-info"><i class="tips-ico"></i><p>如果不填,不限张数</p></div>	    
        </td>
    </tr>
     <tr>
        <td class="leftLabel"><cite>*</cite>需要积分：</td>
        <td><label><input type="text" value="0" class="w100" name="require">&nbsp;分</label>  <div class="tips tips-info"><i class="tips-ico"></i><p>需要多少积分能兑换券(0分则不需要积分)</p></div>		
        </td>
    </tr>
    <tr>
        <td class="leftLabel"><cite>*</cite>有效期：</td>
        <td>
          <label class="mr20"><input type="text" id='end_time' name="end_time" onfocus="WdatePicker({startDate:'%y-%M-{%d+1}0:0:0',dateFmt:'yyyy-MM-dd HH:mm:ss',doubleCalendar:true,minDate:'%y-%M-%d',maxDate:'{%y+1}-%M-%d'})"  value="" name="end_time" title="请选择开始日期" class="Wdate" style="width:140px;background-position-x: 128px!important;"></label>
          <div class="tips" style="display: none;"></div>
        </td>
     </tr>
    <tr class="space">
    ...
    <tr>
        ...
        <td>
            <input class="submit mr20" type="submit" id="editInnsButton" value="确认"><input class="cancel" type="button" id="cancel" value="取消"><div 
...
<script type="text/javascript">
	$(function(){
		...
		form_sub.ajaxForm({
            dataType : 'json',
			type:'POST',
            url:'<?php echo $baseUrl.'coupon/add_coupon'?>',
