<div class="orderView form">
    ...
    <table class="wp100" style="line-height: 25px; margin-bottom: 15px;">
        ...
        <?php if($order['seller_inn']):?>
			<td>销售账号：<!--<a href="<?php echo $baseUrl.'inns/manager?innsid='.$order['seller_inn'];?>"></a>--><?php echo $userinfo[$order['user_id']]['real_name']?$userinfo[$order['user_id']]['real_name']:$userinfo[$order['user_id']]['user_name'];?>
			</td>
		<?php endif;?>
        </tr>
        </tbody>
