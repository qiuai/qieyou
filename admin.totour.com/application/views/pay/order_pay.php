...
<style type="text/css">
body{background:#ededec;text-align:center;color: #333;font-family:"Hiragino Sans GB",arial,helvetica,clean;margin:0px;}
...
.alipay_img {background-image:url('<?php echo $this->config->item("static");?>images/alipay.png');background-size: 100%;margin: 0 10px 0 12px;height: 36px;width: 60px;display:inline-block;vertical-align: middle;background-repeat: no-repeat;}
