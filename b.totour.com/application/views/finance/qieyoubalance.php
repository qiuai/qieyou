...
<div class="filter mb20">
    <table class="form table-form">
        ...
        <tr>
            ...
            <td>
                <label><input type="text" id="startTime" onfocus="WdatePicker({doubleCalendar:true,maxDate:'%y-%M-%d'})" value="<?php if($starttime) echo date('Y-m-d',$starttime);?>" name="starttime" title="请选择开始日期" class="Wdate"></label>
                <span class="mr10">至</span>
                <label><input type="text" id="endTime" onfocus="WdatePicker({doubleCalendar:true,maxDate:'%y-%M-%d'})" value="<?php if($endtime) echo date('Y-m-d',$endtime);?>" name="endtime" title="请选择结束日期" class="Wdate"></label>
