...
<form method="post" id="form_sub">
	...
	<tr>
        ...
        <td><label><input type="text" value="" class="w300" name="group_name"></label>
         <div class="tips" style="display: none;"></div> 	
        </td>
    </tr>
    <tr>
        <td class="leftLabel"><cite>*</cite>创建者：</td>
        <td><label><input type="text" value="" class="w300" name="admins" id="admins"  ></label>
   ...
   <tr>
        <td class="leftLabel"><cite>*</cite>部落头像：</td>
        <td>
            <p>图片尺寸： 400*400px，大小>=100KB(仅参考)，不超过2MB，允许格式'gif', 'jpg', 'jpeg', 'png'</p>
    ...
    <tr>
        ...
        <td>
        <label><textarea class="w600 textEdit" rows="10" cols="103" 
name="note"></textarea></label><div class="tips tips-info"><i class="tips-ico"></i><p>限1000字内
</p></div></label>
        </td>
    </tr>
     <tr>
        ...
        <td>
        <label><input name="join_method" type="radio" value="able"  checked="checked"/>无需审核，任何人可加入
        <br /><input name="join_method" type="radio" value="verify" />需要管理员审核
        <br /><input name="join_method" type="radio" value="noable" />不允许任何人加入</label>
        </td>
    </tr>
    <tr class="space">
        <td>&nbsp;</td>
...
<script type="text/javascript">
	$(function(){
		...
		form_sub.ajaxForm({
            dataType : 'json',
			type:'POST',
            url:'<?php echo $baseUrl.'sysconfig/groups_add'?>',
