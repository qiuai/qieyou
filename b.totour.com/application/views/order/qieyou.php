...
<div class="filter mb20">
    <div class="form p10-20" style="margin-left: 16px;">
        开始日期：<input type="text" id="startTime" onfocus="WdatePicker({doubleCalendar:true,maxDate:'%y-%M-%d'})" value="<?php if($starttime) echo date('Y-m-d',$starttime);?>" name="st" title="请选择开始日期" class="Wdate mr40">
...
<script type="text/javascript" src="/static/js/DatePicker/WdatePicker.js" charset="utf-8"></script>    
