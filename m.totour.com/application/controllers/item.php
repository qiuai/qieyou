...
class Item extends MY_Controller {
	...
	*/
	public function index() 
	{
		...
		if($this->get_user_id())
		{
			$is_fav = $this->model->check_product_fav($product_id,$this->get_user_id());
	...
	public function map()
	{
		...
		$product_id = input_int($this->input->get('id'),0,FALSE,FALSE,'2001');		//商品id	
		$product = $this->model->get_product_by_product_id($product_id,TRUE);
		if(!$product)
		{
			response_code('2001');
