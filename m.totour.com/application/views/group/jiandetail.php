...
<div class="scon-list">
        ...
        <div class="gright">
            <div class="left">
                <ul style="margin-top:-0.5rem">
                    <a href="#">
                    <li class="red">甜美邂逅~<img alt="" src="<?php echo $staticUrl;?>images/boyred.png"/><font>22岁</font> <span><img alt="" src="<?php echo $staticUrl;?>images/jianren5.png"/>捡人贴</span> </li>
    ...
    <div class="list-con2">
        <dl>
            <dd><font>[路线]</font> 云南大理-瑞丽-缅甸</dd>
            <dd><font>[时间]</font> 02-22至03-22</dd>
    ...
    <div class="ping-list">
        ...
        <div class="ping-con">
            ...
            <ul>
                ...
                <li><a class="more" href="#">更多18条评论...</a></li>
            </ul>
        </div>
    </div>
    <%/each%>
</script>
<script type="text/javascript">var REQUIRE = {MODULE: 'page/group/detail', DEP: 'jianren', FORUM_ID: 1};</script>