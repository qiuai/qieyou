...
<table class="orderList table table-border table-odd">
	...
	<tr>
		...
		<td>
            ...
            <a class="changeProductBtn" href="javascript:void(0)" <?php echo 'ref="'.$product['product_id'].'"';?> change="N" target="_blank">下架</a>
			<?php else:?>
            <a class="changeProductBtn" href="javascript:void(0)" <?php echo 'ref="'.$product['product_id'].'"';?> change="Y" target="_blank">上架</a>
			<?php endif;?>
        </td>
	</tr>
	<?php endforeach;?>
