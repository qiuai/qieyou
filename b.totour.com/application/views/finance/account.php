...
<!--分页样式结束-->
<script type="text/javascript" src="/static/js/citySelect.js" charset="utf-8"></script>   
...
/*	var innSelect = $('#innSelect');
	innSelect.change(function(){
		var innVal = innSelect.val();
		if (innVal!=''){
			window.location.href="<?php echo $baseUrl;?>finance/innaccount?sid="+innVal;
		}
	}*/
